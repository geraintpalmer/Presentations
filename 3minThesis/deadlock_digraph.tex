...
\node at (6.6, 1.6) {\huge Frailty Services};
\node at (8.4, 7.6) {\huge Community Services};
\node at (7.5, 16.4) {\huge Hospital Ward};
...
% \pause
% State digraph Nodes
\node (A1) [style={minimum size=2.5cm,draw=black,fill={rgb:yellow,4;orange,2;white,2},text=black,shape=circle}] at (27.5, 10) {\LARGE{$A_1$}};
\node (B1) [style={minimum size=2.5cm,draw=black,fill={rgb:yellow,4;orange,2;white,2},text=black,shape=circle}] at (24.045, 14.755) {\LARGE{$B_1$}};
\node (B2) [style={minimum size=2.5cm,draw=black,fill={rgb:yellow,4;orange,2;white,2},text=black,shape=circle}] at (18.455, 12.939) {\LARGE{$B_2$}};
\node (C1) [style={minimum size=2.5cm,draw=black,fill={rgb:yellow,4;orange,2;white,2},text=black,shape=circle}] at (18.455, 7.061) {\LARGE{$C_1$}};
\node (C2) [style={minimum size=2.5cm,draw=black,fill={rgb:yellow,4;orange,2;white,2},text=black,shape=circle}] at (24.045, 5.245) {\LARGE{$C_2$}};
...
\node[align=center] [style={minimum size=1.4cm, text width=1.0cm, draw=black,fill=red!65!yellow,text=black,shape=circle}] at (3.9, 9.9) {$B_1$};
\node[align=center] [style={minimum size=1.4cm, text width=1.0cm, draw=black,fill=red!65!yellow,text=black,shape=circle}] at (10.2, 15) {$A_1$};
\node[align=center] [style={minimum size=1.4cm, text width=1.0cm, draw=black,fill=red!65!yellow,text=black,shape=circle}] at (3.9, 8.1) {$B_2$};
...
\node (A1) [style={minimum size=2.5cm,draw=black,fill=red!65!yellow,text=black,shape=circle}] at (27.5, 10) {\LARGE{$A_1$}};
\node (B1) [style={minimum size=2.5cm,draw=black,fill=red!65!yellow,text=black,shape=circle}] at (24.045, 14.755) {\LARGE{$B_1$}};
\node (B2) [style={minimum size=2.5cm,draw=black,fill=red!65!yellow,text=black,shape=circle}] at (18.455, 12.939) {\LARGE{$B_2$}};
