...
\only<2>{
\node[text=red] at (0.8, -1.5) {\LARGE{$\widetilde{\Lambda}_{1}$}};
\node[text=red] at (7.8, -1.5) {\LARGE{$\widetilde{\Lambda}_{2}$}};
\node[text=red] at (15.8, -1.5) {\LARGE{$\widetilde{\Lambda}_{3}$}};
\node[text=red] at (23.8, -1.5) {\LARGE{$\widetilde{\Lambda}_{4}$}};
}
...
\only<2>{
\node[text=red] at (13, 2.5) {\LARGE{$\widetilde{r}_{23}$}};
\node[text=red] at (22, 0.5) {\LARGE{$\widetilde{r}_{43}$}};
\node[text=red] at (8.55, 4.5) {\LARGE{$\widetilde{r}_{25}$}};
}
...
\only<2>{
\node at (7.75, 7) {\LARGE{\color{red}{$\widetilde{\mu}_5$}, \color{black}{$c_5$, $n_5$}}};
\node at (19.25, 7) {\LARGE{\color{red}{$\widetilde{\mu}_6$}, \color{black}{$c_6$, $n_6$}}};
}
