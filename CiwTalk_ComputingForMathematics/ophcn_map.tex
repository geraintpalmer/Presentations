...
\node[text width=2cm, align=center] (AE) at (10, 17) {\huge{\textit{A\&E}}};
\node[text width=2cm, align=center] (RPDM) at (8.5, 5.5) {\huge{\textit{Rapid\\Medical}}};
\node[text width=2cm, align=center] (RPDO) at (10, 3) {\huge{\textit{Rapid\\Other}}};
\node[text width=2cm, align=center] (RG) at (15, 12.5) {\huge{\textit{Royal\\Gwent}}};
\node[text width=2cm, align=center] (NH) at (19, 11.25) {\huge{\textit{Neville\\Hall}}};
\node[text width=4.5cm, align=center] (YYF) at (18, 14.5) {\huge{\textit{Ysbyty Ystrad\\Fawr}}};
\node[text width=2cm, align=center] (AO) at (17.5, 5.5) {\huge{\textit{Assessed\\Out}}};
\node[text width=2cm, align=center] (FLS) at (6, 1.5) {\huge{\textit{Falls}}};
\node[text width=2cm, align=center] (RBL) at (8, 0) {\huge{\textit{Reablement}}};
\node[text width=2cm, align=center, text=gray] (CHC) at (15, -3) {\huge{\textit{CHC}}};
\node[text width=2cm, align=center] (CCD) at (3.5, 11.5) {\huge{\textit{Day/Home}}};
\node[text width=2cm, align=center] (CCO) at (3.5, 9.5) {\huge{\textit{Other}}};
\node[text width=2cm, align=center] (RES) at (2.5, -3) {\huge{\textit{Residential}}};
\node (LAIN) at (0, 14) {};
\node (CHCIN) at (0, -5) {};
...
\node[rotate=90, align=center] at (1.5, 10.5) {Local Authority\\Community Care};
\node[rotate=90, align=center] at (4.25, 4.625) {Frailty};
\node[align=center] at (17, 16.25) {Emergency Admission};
