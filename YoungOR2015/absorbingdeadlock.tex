...
\draw[gray, dashed, ->] (10.9, 3.9) [bend right=45] to (12.6, 8.4);
...
\node[align=center] [style={minimum size=1.4cm, text width=1.0cm, draw=black,fill={rgb:yellow,2;orange,4},text=black,shape=circle}] at (10.2, 2.1) {$C_2$};
\draw[gray, dashed, ->] (10.9, 2.1) [bend right=45] to (12.8, 8.6);
