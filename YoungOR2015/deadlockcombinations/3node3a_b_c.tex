...
\begin{tikzpicture}
  ...
  \node (c) [style={minimum size=1.5cm,fill=blue,text=black,shape=circle}] at (1.5, 2.6) {\LARGE{c}};
  ...
  \draw[draw=blue, ultra thick, -triangle 90] (c) to [out=-240,in=-300,looseness=4] (c);
