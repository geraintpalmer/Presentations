...
\begin{tikzpicture}
  ...
  \node (c) [style={minimum size=1.5cm,fill=green,text=black,shape=circle}] at (1.5, 2.6) {\LARGE{c}};
  ...
  \draw[draw=green, ultra thick, -triangle 90] (c) to [out=-240,in=-300,looseness=4] (c);
