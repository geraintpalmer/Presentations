...
\titlegraphic{\includegraphics[width=2.3cm]{cflogo} $\quad$ \includegraphics[width=2.3cm]{ciw_logo} $\quad$ \includegraphics[width=2.3cm]{napycon_logo} $\quad$ \includegraphics[width=2.3cm]{pydifflogo}}
