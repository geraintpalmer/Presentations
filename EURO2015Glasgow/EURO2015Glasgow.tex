...
\begin{frame}
    \frametitle{Times to Deadlock - $\Lambda_1$}
    \includegraphics[width=\textwidth]{varyL1}
\end{frame}
\begin{frame}
    \frametitle{Times to Deadlock - $\mu_1$}
    \includegraphics[width=\textwidth]{varymu1}
\end{frame}
\begin{frame}
    \frametitle{Times to Deadlock - $r_{12}$}
    \includegraphics[width=\textwidth]{varyr12}
\end{frame}
\begin{frame}
    \frametitle{Times to Deadlock - $n_1$}
    \includegraphics[width=\textwidth]{varyn1}
\end{frame}
